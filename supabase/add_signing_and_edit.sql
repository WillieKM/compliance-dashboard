...
-- Staff: onboarding document upload token
ALTER TABLE staff ADD COLUMN IF NOT EXISTS onboarding_token TEXT UNIQUE;
...
-- Generate tokens for all existing staff that don't have one
