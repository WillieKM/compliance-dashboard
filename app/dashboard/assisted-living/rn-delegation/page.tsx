...
export default async function RNDelegationPage() {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">WAC 388-78A-2240 · RN must delegate medication management to each staff member</p>
        </div>
        <Link href="/dashboard/assisted-living/rn-delegation/new"
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        {all.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-slate-500 text-sm mb-4">WAC 388-78A-2240 requires RN delegation for all staff who assist with medications.</p>
            <Link href="/dashboard/assisted-living/rn-delegation/new" className="inline-block px-6 py-2.5 rounded-lg text-white font-bold text-sm" style={{ backgroundColor: purple }}>Add First Delegation</Link>
          </div>
        ) : (
      ...
      <div className="rounded-xl p-4 text-sm bg-purple-50 border border-purple-200">
        <p className="font-bold text-purple-900 mb-1">WAC 388-78A-2240 Requirements</p>
        <ul className="text-purple-800 space-y-0.5">
          <li>• A licensed RN must delegate medication assistance to each qualified staff member</li>
