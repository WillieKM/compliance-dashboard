...
export default async function ALVisitDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        <Link href="/dashboard/assisted-living/visits" className="text-sm hover:underline" style={{ color: purple }}>
          ← Visit Log
        </Link>
        <h1 className="text-2xl font-bold mt-2" style={{ color: purple }}>
