...
export default async function NewMedicationPage() {
  ...
  async function saveMedication(formData: FormData) {
    ...
    redirect("/dashboard/afh/medications");
  }
    ...
    <div className="max-w-2xl space-y-6">
      ...
      <form action={saveMedication} className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-5">
          ...
          <div className="sm:col-span-2">
            <label className="flex items-center gap-3 p-3 rounded-xl border-2 border-red-200 bg-red-50 cursor-pointer">
              ...
              <div>
                ...
                <p className="text-xs text-red-700">Requires count log and reconciliation per WAC 388-76-10540</p>
              </div>
            </label>
          </div>
          <div className="sm:col-span-2">
        ...
        <div className="flex gap-3 pt-2">
          ...
          <Link href="/dashboard/afh/medications" className="px-6 py-3 rounded-xl border border-slate-300 font-semibold text-slate-700 hover:bg-slate-50">
            Cancel
          </Link>
        </div>
      </form>
